...
const softwareEng=employeess.filter(e=>e.designation==="Software Engineer");
...
const highSallery=employes.filter(e=>e.salary>80000);
...
const highratting=doctor.filter(doc=>doc.rating>4.5);
...
const docinKolkata=doctorss.filter(doc=>doc.city==="Kolkata");
